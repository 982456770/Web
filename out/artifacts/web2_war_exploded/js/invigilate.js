...
$(function () {
    ...
    $.ajax({ //页面加载成功，获取当前模块的所有数据
        ...
        success: function (response) {
            ...
            for (let i in response) {
                $(".nav_content>.content").append(`<div class="task_box" task_id=${response[i].invigilate_id}></div>`);
             ...
             <p class="task_title">${response[i].subject}</p>
    ...
    $("#btn_submit").on("click", function () { //提交保存
        var data = {
            "examSubject": $("#txt_exam_subject").val(),
            "place": $("#txt_exam_place").val(),
            "class": $("#txt_exam_class").val(),
            "durationTime": $("#txt_exam_duration_time").val(),
            "invigilator": peopleArr,
            "time": $("#txt_exam_time").val(),
            "other": $("#txt_exam_desc").val(),
