...
public class MeetingServlet {
	...
	@RequestMapping("/task_management/SelMeeting")
	protected void SelMeetingbyid(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		for(int j=0;j<list.size();j++)
		{
			...
			employee.put("meetingid", list.get(j).getMeeting_id());
	...
	@RequestMapping("/task_management/MOCK/SelMeeting")
	protected void SelMeetingbyid2(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	...
	@RequestMapping("/task_management/SelDoingMeeting")
	protected void SelDoingMeetingbyid(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.setCharacterEncoding("utf-8");
		HttpSession hs=req.getSession();
		int id=(int) hs.getAttribute("id");
		List<Meeting> list = meetingService.selByid(id);
	...
	@RequestMapping("/task_management/SelDoneMeeting")
	protected void SelDoneMeetingbyid(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.setCharacterEncoding("utf-8");
		HttpSession hs=req.getSession();
		int id=(int) hs.getAttribute("id");
		List<Meeting> list = meetingService.selByid(id);
	...
	@RequestMapping("/task_management/InsMeeting")
//	public Object func(@RequestBody List<User> userList)  {
//		// @RequestBody 需要该注解
//		System.out.println(userList);
//		return "meeting.html";
//	}
	protected String InsMeeting(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.setCharacterEncoding("utf-8");
		HttpSession hs=req.getSession();
		int id=(int) hs.getAttribute("id");
	...
	@RequestMapping("/task_management/DelMeeting")
	protected String DelMeeting(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		meetingService.delmeeting(meeting_id);
